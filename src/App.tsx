...
const texts: string[] = [
  ...
  "När det sedan kommer till att göra, låt den som känner sig mest osäker sitta vid tangentbordet. Detta medför att den mer erfarne delar med sig av kunskap kring koden, verktygen och domänen.",
  "Parprogrammeringens syfte är långsiktighet t.ex. dela kunskap och T-shape:a teamet. Hur många timmar tar det tills ni båda är kunniga på detta ställe och med dessa verktyg? Skruva därför ned volymen på rösten som säger 'men det kommer ju gå mycket fortare om du som kan detta gör det!' - den rösten är en röst av stress och press.",
